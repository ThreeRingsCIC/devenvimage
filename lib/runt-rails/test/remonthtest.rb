...
class REMonthTest < BaseExpressionTest
  def test_20th_thru_29th_of_every_month
   ...
   assert expr.include?(@date_20050123), "Expression #{expr} should include #{@date_20050123}"
   assert !expr.include?(@date_20050116), "Expression #{expr} should not include #{@date_20050116}"
  end

  def test_16th_of_every_month
    expr = REMonth.new(16)
   assert expr.include?(@date_20050116), "Expression #{expr} should include #{@date_20050116}"
   assert !expr.include?(@date_20050123), "Expression #{expr} should not include #{@date_20050123}"
  end
