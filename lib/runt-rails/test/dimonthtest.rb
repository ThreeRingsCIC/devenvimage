...
class DIMonthTest < BaseExpressionTest
  ...
  def test_third_friday_of_the_month
    ...
    assert expr.include?(@date_20040116), "Third Friday of the month should include #{@date_20040116}"
    assert !expr.include?(@date_20040109), "Third Friday of the month should not include #{@date_20040109}"
  end

  def test_second_friday_of_the_month
    expr = DIMonth.new(Second, Friday)
    assert expr.include?(@date_20040109), "Second Friday of the month should include #{@date_20040109}"
    assert !expr.include?(@date_20040116), "Second Friday of the month should not include #{@date_20040116}"
  end
